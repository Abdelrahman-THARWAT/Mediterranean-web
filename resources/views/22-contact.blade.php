                    ...
                    <div class="bar-right d-flex justify-content-end">
                        <ul class="list-unstyled list-inline bar-menu">
                            ...
                            <li class="list-inline-item"><a href="#"><i
                                        class="la la-question"></i>{{ __('content.help') }}</a></li>
                        </ul>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <a href="#"><img src={{ asset('images/logo.png') }} alt=""
                                    style="width: 20em; margin-bottom: 2em;"></a>
                            <ul class="list-unstyled">
                                <li><a href="/">{{ __('content.home') }}</a>

                                </li>
                                <li><a href="/"> {{ __('content.about_us') }} </a>

                                </li>
                                <li><a href="/">{{ __('content.services') }}</a>

                                </li>
                                <li><a href="/">{{ __('content.major_shareholders') }}</a>

                                </li>
                                <li><a href="/">{{ __('content.corporate_news') }}</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-box text-center">
                        ...
                        <ul class="list-unstyled list-inline">
                            <li class="list-inline-item"><a href="/"><i
                                        class="la la-home"></i>{{ __('content.home') }}</a> <i
                                    class="la la-angle-right"></i></li>
    ...
    <section class="contact-area">
        <div class="container">
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p><input type="text" id="name" name="name"
                                                placeholder="{{ __('content.name_placeholder') }}"></p>
                                    </div>
                                    <div class="col-md-12">
                                        <label>{{ __('content.email_label') }}</label>
                                        <p><input type="text" id="email" name="email"
                                                placeholder="{{ __('content.email_placeholder') }}"></p>
                                    </div>
                                    <div class="col-md-12">
                                        <label>{{ __('content.message_label') }}</label>
                                        <p>
                                            <textarea name="message" id="message" placeholder="{{ __('content.message_placeholder') }}"></textarea>
                                        </p>
                                    </div>
                                    <div class="col-md-12">
                ...
                <div class="col-lg-6 col-md-12">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d863.5270125236174!2d31.21322166952455!3d30.03375785946891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145846d6804ff6dd%3A0xd0ebe58f0e5962ec!2s15%20Al%20Mesaha%2C%20Ad%20Doqi%20A%2C%20Dokki%2C%20Giza%20Governorate%203750311!5e0!3m2!1sen!2seg!4v1737662573122!5m2!1sen!2seg"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="f-link">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="#"><i
                                        class="la la-angle-right"></i>{{ __('content.general_info') }}</a></li>
                            <li><a href="#"><i
                                        class="la la-angle-right"></i>{{ __('content.help_center') }}</a></li>
                            <li><a href="#"><i class="la la-angle-right"></i>{{ __('content.services') }}</a>
                            </li>
                            <li><a href="#"><i
                                        class="la la-angle-right"></i>{{ __('content.privacy_policy') }}</a></li>
                            <li><a href="#"><i
                                        class="la la-angle-right"></i>{{ __('content.online_support') }}</a></li>
                            <li><a href="#"><i class="la la-angle-right"></i>{{ __('content.blog_posts') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <footer class="footer-btm">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="copy-text">
                        <p>{{ __('content.copyright') }} <a href="#" target="_blank">Abdelelrahman Tharwat</a>
                        </p>
                    </div>
                </div>
